...
const ServiceIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    viewBox="0 0 20 20"
    fill="none"
    className={cn('stroke-secondary dark:stroke-accent', className)}>
    <path
...
const CareerIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={cn('stroke-secondary dark:stroke-accent h-[15px] w-4', className)}
    viewBox="0 0 16 15"
    fill="none">
    <path
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M7.06152 6.75H8.93652" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

const ManifestoIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={cn('stroke-secondary dark:stroke-accent size-4', className)}
    viewBox="0 0 16 16"
    fill="none">
    <path d="M7.375 10.5H4.875V8L12.375 0.5L14.875 3L7.375 10.5Z" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M10.5 2.375L13 4.875" strokeLinecap="round" strokeLinejoin="round" />
    <path
...
const WhyChooseUsIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
const CustomersIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={cn('stroke-secondary dark:stroke-accent h-[17px] w-[14px] shrink-0', className)}
    viewBox="0 0 14 17"
    fill="none">
    <path
...
const UseCaseIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 18"
    fill="none"
    className={cn('stroke-secondary dark:stroke-accent h-[18px] w-[14px]', className)}>
    <path d="M3.625 16.7501H9.875" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M6.75 14.2501V9.87506" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M4.25 7.37506L6.75 9.87506L9.25 7.37506" strokeLinecap="round" strokeLinejoin="round" />
    <path
...
const TestimonialIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 15" fill="none" className={cn('h-[15px] w-4', className)}>
    <path
...
const AnalyticsIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    viewBox="0 0 20 20"
    fill="none">
    <path d="M5 16.6667V11.6667" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M15 16.6666V8.33331" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M10 16.6666V3.33331" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const SecurityIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={cn('stroke-secondary dark:stroke-accent h-4 w-[15px]', className)}
    viewBox="0 0 15 16"
    fill="none">
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M10.8125 4.875L6.22914 9.25L3.9375 7.0625" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

const WhitePaperIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={cn('stroke-secondary dark:stroke-accent h-[17px] w-[14px]', className)}
    viewBox="0 0 14 17"
    fill="none">
    <path d="M4.25 10.5H9.25" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M4.25 8H9.25" strokeLinecap="round" strokeLinejoin="round" />
    <path
      d="M9.25015 1.75H12.375C12.5408 1.75 12.6997 1.81585 12.8169 1.93306C12.9342 2.05027 13 2.20924 13 2.375V15.5C13 15.6658 12.9342 15.8247 12.8169 15.9419C12.6997 16.0592 12.5408 16.125 12.375 16.125H1.125C0.95924 16.125 0.800269 16.0592 0.683058 15.9419C0.565848 15.8247 0.5 15.6658 0.5 15.5V2.375C0.5 2.20924 0.565848 2.05027 0.683058 1.93306C0.800269 1.81585 0.95924 1.75 1.125 1.75H4.24983"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const BrandKitIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={cn('stroke-secondary dark:stroke-accent size-4', className)}
    viewBox="0 0 16 16"
...
const DownloadIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M5.83301 8.33331L9.99967 12.5L14.1663 8.33331" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M10 12.5V2.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const BlogIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M8 2.74109L12.375 7.11609" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

const TutorialIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={cn('stroke-secondary dark:stroke-accent h-[18px] w-[14px]', className)}
    viewBox="0 0 14 18"
...
const FaqIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M8.625 13.625C9.14277 13.625 9.5625 13.2053 9.5625 12.6875C9.5625 12.1697 9.14277 11.75 8.625 11.75C8.10723 11.75 7.6875 12.1697 7.6875 12.6875C7.6875 13.2053 8.10723 13.625 8.625 13.625Z" />
    <path
      d="M8.625 9.87537V9.25037C9.05765 9.25037 9.48058 9.12207 9.84031 8.88171C10.2 8.64134 10.4804 8.2997 10.646 7.89999C10.8116 7.50027 10.8549 7.06044 10.7705 6.63611C10.6861 6.21177 10.4777 5.822 10.1718 5.51607C9.86587 5.21014 9.47609 5.0018 9.05176 4.9174C8.62743 4.83299 8.18759 4.87631 7.78788 5.04188C7.38817 5.20745 7.04653 5.48782 6.80616 5.84756C6.5658 6.20729 6.4375 6.63022 6.4375 7.06287"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const GlossaryIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    viewBox="0 0 14 16"
    fill="none"
    className={cn('stroke-secondary dark:stroke-accent size-[14px] h-[16px]', className)}>
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M0.5 14.875V15.5H11.75" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const LoginIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    viewBox="0 0 17 17"
    fill="none"
    className={cn('stroke-secondary dark:stroke-accent size-[17px]', className)}>
    <path
...
const SignUpIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={cn('stroke-secondary dark:stroke-accent h-[16px] w-[17px]', className)}
    viewBox="0 0 17 16"
    fill="none">
    <path
...
const ReferralProgramIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 16 14"
    fill="none"
    className={cn('stroke-secondary dark:stroke-accent h-[14px] w-[16px]', className)}>
    <path d="M11.75 8L15.5 4.25L11.75 0.5" strokeLinecap="round" strokeLinejoin="round" />
    <path
...
const AffiliateProgramIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    className={cn('stroke-secondary dark:stroke-accent h-[14px] w-[20px]', className)}
    viewBox="0 0 20 14"
    fill="none">
    <path
...
const AffiliatePolicyIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 20 20"
    fill="none"
    className={cn('stroke-secondary dark:stroke-accent size-[20px]', className)}>
    <path
...
const TermsConditionsIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 20 20"
    fill="none"
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M10.833 1.66669V7.50002H16.6663" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
...
const RefundPolicyIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 20 20"
    fill="none"
    className={cn('stroke-secondary dark:stroke-accent size-[20px]', className)}>
    <g clipPath="url(#clip0_4483_29796)">
      <path
...
const GDPRIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 20 20"
    fill="none"
...
const LegalNoticeIcon = ({ className }: { className?: string }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 14 16"
    fill="none"
    className={cn('stroke-secondary dark:stroke-accent h-4 w-[14px]', className)}>
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M8.62598 0.5V4.875H13.0016" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M4.25098 8.625H9.25098" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M4.25098 11.125H9.25098" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
